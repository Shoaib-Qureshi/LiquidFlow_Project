                                            ...
                                            <div className="py-4">
                                                <div className="bg-white shadow rounded-lg overflow-hidden">
                                                            ...
                                                            <tbody className="bg-white divide-y divide-gray-100">
                                                                {projects.data.map((project, idx) => (
                                                                    <tr key={project.id} className={idx % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                                                                        ...
                                                                        <td className="px-6 py-4 whitespace-normal text-sm text-gray-700">{project.description}</td>
                                                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{project.created_at}</td>
                                                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                                            <Link href={route("project.show", project.id)} className="text-sm text-indigo-600 hover:text-indigo-900">View</Link>
                                                                        </td>
                                                                    </tr>
                                                                ))}
                                                            </tbody>
                                                    ...
                                                    <div className="px-4 py-3 bg-gray-50 sm:px-6 flex items-center justify-end">
                                                        <Pagination links={projects.links ?? projects.meta?.links ?? []} />
                                                    </div>
                                                </div>
                                            </div>
                                            <th className="px-3 py-3"></th>
