...
<head>
    ...
    <title>Your {{ $appName }} Access</title>
</head>
...
<body style="margin:0; padding:0; background-color:#f5f7fb; font-family:'Segoe UI', Arial, sans-serif;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f5f7fb; padding:32px 0;">
        <tr>
            <td align="center">
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px; max-width:95%; background:#ffffff; border-radius:28px; overflow:hidden; box-shadow:0 20px 45px rgba(42, 67, 113, 0.12); margin:20px auto;">
                    <tr>
                            ...
                            <div style="border-radius:24px; overflow:hidden; background:linear-gradient(145deg,#5c7cfa,#96a7ff); padding:0;">
                                <div style="padding:56px 40px; text-align:center;">
                                    ...
                                    <h1 style="margin:12px 0 0 0; font-size:26px; color:#ffffff; font-weight:700;">
                                        Your LiquidFLow Portal Is Ready
                                    </h1>
                                    <p style="margin:18px 0 0 0; font-size:14px; color:#f8fbff; max-width:440px; line-height:1.6; display:inline-block;">
                                        You now have access to {{ $appName }} to collaborate on <strong>{{ $client->name }}</strong>. Use the credentials below to sign in and start reviewing projects, brands, and tasks in real time.
                                    </p>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td style="padding:0 32px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style=" padding:24px 28px;">
                                <tr>
